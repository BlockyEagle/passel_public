...
pins_channel = 748788755808387133

# TODO
# add any black listed channel IDs as a list separated by a comma (,)
# a good idea is to add admin channels to this
blacklisted_channels = [796313678416445480,672883464680243228,676497488399695893,1064134858944819260,817026269630955620,775298187652235284,673494970660945952,867532419480551454,947169436681527326,889906692047900723,734916654735163472,755751743488262175]
...
client.run('MTA3NjkxNjE0NjY1MTAxNzMzNg.GLemMf.ygJUqvAjVO_UHr2ClqtIYg-Cl8VVijJP6YCIMk
')
